...
import static com.example.artur.findme.R.layout.send;
import static com.example.artur.findme.R.layout.wyslijbezwyboru;
...
public class Send extends AppCompatActivity{
    ...
    private Intent generuj_intent(Context context)
    {
        Intent intent = new Intent(context,WyslijBezWyboru.class);
        intent.putExtra(coordy,s);
        intent.putExtra(coodry_tylko,s_tylko);
